class PaydeceSellerRequest {
  bool? ok;
  Data? data;
  Null? error;

  PaydeceSellerRequest({ok, data, error});

  PaydeceSellerRequest.fromJson(Map<String, dynamic> json) {
    ok = json['ok'];
